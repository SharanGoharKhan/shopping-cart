...
export default class Collapse extends Component<Props> {
    ...
    render() {
        ...
        if( this.state.show )   
            renderArrow = (<Image style={{height:moderateScale(13), width:moderateScale(13)}} source={require('../../../assets/icons/uparrow.png')}/>)
        ...
        React.Children.forEach(this.props.children,(child)=>{
            ...
            if(header === null){
                ...
                return (
                    <View {...this.props} style={{width:'90%',marginBottom:moderateScale(10), borderBottomWidth:1,
                    borderColor: colors.greyLinesColor, paddingBottom: moderateScale(10)}}>
                        {header}
                        {body}
                    </View>
                );
